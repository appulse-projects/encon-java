...
package io.appulse.encon.module.connection.control;

import static io.appulse.encon.module.connection.control.ControlMessageTag.REG_SEND;
import static io.appulse.encon.terms.Erlang.EMPTY_ATOM;

import io.appulse.encon.module.connection.control.exception.ControlMessageParsingException;
...
public class SendToRegisteredProcess extends ControlMessage {
