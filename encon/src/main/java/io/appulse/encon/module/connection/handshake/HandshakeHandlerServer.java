...
import static io.appulse.encon.module.connection.handshake.message.StatusMessage.Status.OK;
...
import io.appulse.encon.module.connection.handshake.exception.HandshakeException;
import io.appulse.encon.module.connection.handshake.message.ChallengeAcknowledgeMessage;
import io.appulse.encon.module.connection.handshake.message.ChallengeMessage;
import io.appulse.encon.module.connection.handshake.message.ChallengeReplyMessage;
import io.appulse.encon.module.connection.handshake.message.Message;
import io.appulse.encon.module.connection.handshake.message.NameMessage;
import io.appulse.encon.module.connection.handshake.message.StatusMessage;
...
class HandshakeHandlerServer extends AbstractHandshakeHandler {
  ...
  @Builder
  HandshakeHandlerServer (NodeInternalApi internal, CompletableFuture<Connection> future) {
