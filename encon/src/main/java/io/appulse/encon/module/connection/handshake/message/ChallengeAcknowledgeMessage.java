...
package io.appulse.encon.module.connection.handshake.message;

import static io.appulse.encon.module.connection.handshake.message.MessageType.CHALLENGE_ACKNOWLEDGE;
