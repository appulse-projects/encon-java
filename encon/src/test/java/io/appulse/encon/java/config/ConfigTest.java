...
import static io.appulse.encon.java.common.DistributionFlag.BIG_CREATION;
import static io.appulse.encon.java.common.DistributionFlag.BIT_BINARIES;
import static io.appulse.encon.java.common.DistributionFlag.EXTENDED_PIDS_PORTS;
import static io.appulse.encon.java.common.DistributionFlag.EXTENDED_REFERENCES;
import static io.appulse.encon.java.common.DistributionFlag.FUN_TAGS;
import static io.appulse.encon.java.common.DistributionFlag.MAP_TAG;
import static io.appulse.encon.java.common.DistributionFlag.NEW_FLOATS;
import static io.appulse.encon.java.common.DistributionFlag.NEW_FUN_TAGS;
import static io.appulse.encon.java.common.DistributionFlag.UTF8_ATOMS;
...
import io.appulse.encon.java.common.DistributionFlag;
  ...
  public void defaultDefaults () {
    ...
    SoftAssertions.assertSoftly(softly -> {
      ...
      softly.assertThat(defaults.getMailbox().getHandler())
          .isEqualTo(io.appulse.encon.java.module.mailbox.DefaultMailboxHandler.class);
