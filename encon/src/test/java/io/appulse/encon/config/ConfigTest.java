...
import static io.appulse.encon.module.mailbox.MailboxType.CACHED;
...
import io.appulse.encon.module.mailbox.MailboxType;
  ...
  public void defaultDefaults () {
    ...
    SoftAssertions.assertSoftly(softly -> {
      ...
      softly.assertThat(defaults.getMailbox().getHandler())
          .isEqualTo(io.appulse.encon.module.mailbox.DefaultMailboxHandler.class);
