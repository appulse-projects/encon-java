...
import static io.appulse.encon.java.terms.TermType.LARGE_TUPLE;
import static io.appulse.encon.java.terms.TermType.LIST;
import static io.appulse.encon.java.terms.TermType.MAP;
import static io.appulse.encon.java.terms.TermType.SMALL_TUPLE;
...
public interface CollectionTerm extends ValueTerm, Iterable<ErlangTerm> {
   ...
   * {@link io.appulse.encon.java.terms.TermType#MAP},
   * {@link io.appulse.encon.java.terms.TermType#LIST},
   * {@link io.appulse.encon.java.terms.TermType#SMALL_TUPLE} or
   * {@link io.appulse.encon.java.terms.TermType#LARGE_TUPLE}.
   *
  ...
  /**
   * Method that returns true if this term is a {@link io.appulse.encon.java.terms.TermType#LIST} term,
   * false otherwise.
   *
  ...
  /**
   * Method that returns true if this term is an {@link io.appulse.encon.java.terms.TermType#SMALL_TUPLE} or
   * {@link io.appulse.encon.java.terms.TermType#LARGE_TUPLE} term, false otherwise.
   *
  ...
  /**
   * Method that returns true if this term is a {@link io.appulse.encon.java.terms.TermType#MAP} term,
   * false otherwise.
   *
