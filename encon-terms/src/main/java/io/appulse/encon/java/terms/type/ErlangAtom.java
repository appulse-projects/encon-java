...
import static io.appulse.encon.java.terms.TermType.ATOM_UTF8;
import static io.appulse.encon.java.terms.TermType.SMALL_ATOM;
import static io.appulse.encon.java.terms.TermType.SMALL_ATOM_UTF8;
...
public class ErlangAtom extends ErlangTerm {
  ...
  public ErlangAtom (@NonNull TermType type, @NonNull ByteBuf buffer) {
    super(type);
