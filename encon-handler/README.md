...
[![maven_central](https://maven-badges.herokuapp.com/maven-central/io.appulse.encon/encon-handler/badge.svg)](https://search.maven.org/search?q=a:encon-handler)
[![License](http://img.shields.io/:license-apache-brightgreen.svg)](http://www.apache.org/licenses/LICENSE-2.0.html)
[![JavaDoc](http://www.javadoc.io/badge/io.appulse.encon/encon-handler.svg)](http://www.javadoc.io/doc/io.appulse.encon/encon-handler)
...
```groovy
compile 'io.appulse.encon:encon-handler:1.6.10'
```
